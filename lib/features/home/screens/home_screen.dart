...
class _HomeScreensState extends State<HomeScreens> {
  ...
  Future<void> _handleRefresh() async {
    _loadData();
    // Menunggu kedua Future selesai untuk menghilangkan indikator loading
    await Future.wait([_futureCourses, _futureTasks]);
  }
  ...
  // Fungsi baru untuk mengecek apakah kelas sudah terlewati
  ...
  Widget build(BuildContext context) {
    // Membungkus SingleChildScrollView dengan RefreshIndicator
              ...
              builder: (context, snapshot) {
                ...
                return ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    final isPassed = _isClassPassed(course.end_time);
  ...
  Widget _buildTimelineItem({
    ...
    return IntrinsicHeight(
      child: Opacity(
        // Meredupkan keseluruhan item jika kelas sudah selesai
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        boxShadow: [
                          if (!isPassed) // Hilangkan bayangan jika sudah selesai
                            BoxShadow(
                              ...
                              Expanded(
                                child: Text(
                                  ...
                                  style: TextStyle(
                                    fontSize: 16,
                                    fontWeight: FontWeight.bold,
                                    // Mencoret nama mata kuliah jika sudah lewat
                                    decoration: isPassed
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const Spacer(), // Spacer akan mendorong sisa teks ke bawah dengan aman
          const SizedBox(height: 12), // Jarak minimal agar tidak berdempetan
          Text(
            value,
            maxLines: 2,
            overflow: TextOverflow.ellipsis,
